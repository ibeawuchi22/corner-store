...
<body>
  ...
  <div id="n2">
   ...
   <div id="crumb" class="mt-5">
    ...
    <div class="product" data-brand="Suitcase" data-color="Black" data-casing="Hard" data-price="100">
        <img style="padding-right: 20px;" src="../img/suitcase5.webp" alt="Suitcase">
        <div id="det">
          ...
          <h2 id="ser">Black Male Suitcase</h2>
          <div id="rate">
            <p >Rating:</p>
            <div class="rating">
          ...
          <button class="btn" onclick="addToCart('Suitcase', 50.00, './img/suitcase5.webp')">Add to Cart</button>
    ...
    <div id="content" class="content">
        ...
        <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Customer Reviews</h4>
          ...
          <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; margin-top: 20px;">You're reviewing: Black Male Suitcase</h4>
