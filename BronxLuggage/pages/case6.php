  ...
  <div id="n2">
   ...
   <div id="crumb" class="mt-5">
    ...
    <div class="product" data-brand="Suitcase" data-color="Red" data-casing="Hard" data-price="50">
        <img style="padding-right: 20px;" src="../img/suitcase3.webp" alt="Suitcase">
        <div id="det">
          ...
          <button class="btn" onclick="addToCart('Suitcase', 50.00, './img/suitcase3.webp')">Add to Cart</button>
