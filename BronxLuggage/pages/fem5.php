  ...
  <div id="n2">
   ...
   <div id="crumb" class="mt-5">
    ...
    <div class="product" data-brand="Backpack" data-color="Blue" data-casing="Soft" data-price="30">
        <img style="padding-right: 20px;" src="../img/femalebak5.jpg" alt="Backpack">
        <div id="det">
          ...
          <h2 id="ser">Blue Female Backpack</h2>
          <div id="rate">
            <p >Rating:</p>
            <div class="rating">
          ...
          <button class="btn" onclick="addToCart('Backpack', 30.00, './img/femalebak5.jpg')">Add to Cart</button>
    ...
    <div id="content" class="content">
        ...
        <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Customer Reviews</h4>
          ...
          <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; margin-top: 20px;">You're reviewing: Blue Female Backpack</h4>
