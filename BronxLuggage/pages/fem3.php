...
<body>
  ...
  <div id="n2">
   ...
   <div id="crumb" class="mt-5">
    ...
    <div class="product" data-brand="Duffel Bag" data-color="Red" data-casing="Hard" data-price="20">
        <img style="padding-right: 20px;" src="../img/duffel6.jpg" alt="Duffel Bag">
        <div id="det">
          ...
          <h2 id="ser">Red Female Duffel Bag</h2>
          <div id="rate">
            <p >Rating:</p>
            <div class="rating">
          ...
          <button class="btn" onclick="addToCart('Duffel Bag', 20.00, './img/duffel6.jpg')">Add to Cart</button>
    ...
    <div id="content" class="content">
        ...
        <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Customer Reviews</h4>
          ...
          <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; margin-top: 20px;">You're reviewing: Red Female Duffel Bag</h4>
