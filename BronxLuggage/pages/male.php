...
<body onload="myFunction1()" id="myPage">
  ...
  <div id="n2">
    ...
    <ul id="sex">
      <li><a href="male.php"  style="background-color: rgb(207, 7, 7); padding: 13px; padding-top: 5px; color: white;">Male</a></li>
   ...
   <div id="crumb" class="mt-5">
    <ul class="breadcrumb ">
        ...
        <li class="breadcrumb-item"><a href="male.php">Male</a></li>
       
    </ul>
    <h1 id="luggy" style="position: absolute; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Male</h1>
</div>
  ...
  <option value="">30</option>
    ...
    <div class="products">
      <div class="product" data-brand="Suitcase" data-color="Black" data-casing="Hard" data-price="100">
        <img src="../img/suitcase5.webp" alt="Suitcase">
        <div id="card">
          <h4>Suitcase</h4>
          <p>$100.00</p>
          <a class="btn btn-secondary bg-gradient" href="case10.php" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">preview</a><br>
          <button id="bt" class="btn btn-add-to-cart" onclick="addToCart('Suitcase', 100.00, './img/suitcase5.webp')">add to cart <i class="fa-solid fa-cart-shopping" style="font-size: 20;"></i></button>
