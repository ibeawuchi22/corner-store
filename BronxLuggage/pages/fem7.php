  ...
  <div id="n2">
   ...
   <div id="crumb" class="mt-5">
    ...
    <div class="product" data-brand="Suitcase" data-color="Red" data-casing="Hard" data-price="50">
        <img style="padding-right: 20px;" src="../img/femalered2.jpg" alt="Suitcase">
        <div id="det">
          ...
          <h2 id="ser">Red Female Suitcase</h2>
          <div id="rate">
            <p >Rating:</p>
            <div class="rating">
          ...
          <button class="btn" onclick="addToCart('Suitcase', 50.00, './img/femalered2.jpg')">Add to Cart</button>
    ...
    <div id="content" class="content">
        ...
        <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Customer Reviews</h4>
          ...
          <h4 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; margin-top: 20px;">You're reviewing: Red Female Suitcase</h4>
