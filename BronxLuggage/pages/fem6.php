  ...
  <div id="n2">
   ...
   <div id="crumb" class="mt-5">
    ...
    <div class="product" data-brand="Suitcase" data-color="Red" data-casing="Hard" data-price="50">
        <img style="padding-right: 20px;" src="../img/femalered1.jpg" alt="Suitcase">
        <div id="det">
          ...
          <button class="btn" onclick="addToCart('Suitcase', 50.00, './img/femalered1.jpg')">Add to Cart</button>
