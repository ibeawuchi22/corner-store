...
<body onload="myFunction1()" id="myPage" style="background-color: grey;">
<iframe id="loader" src="./loader/loader2.php" style="display: block; border: none; width: 100%; height: 100vh;"></iframe>
    ...
    <div class="container" style="margin: auto; padding-right: 0;">
        <div  id="loginContainer" class="form-container login">
            ...
            <form action="../includes/loginsub.php" method="POST" id="loginForm">
             ...
             <form action="../includes/registersub.php" method="POST" enctype="multipart/form-data" id="registerForm">
                <?php if(isset($_GET['error'])){ ?>
                 <div class="alert alert-danger alert-dismissible">
                    <button class="btn-close" data-bs-dismiss="alert"></button>
                    <p><?php echo $_GET['error']?></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="name" required id="" style="height: 40px; width: 90%;">
                </div>
                <div class="form-group">
                    <label for="name">Phone:</label>
                    <input type="text"  name="phone"  required id="" style="height: 40px; width: 90%;">
                </div>
                <div class="form-group">
                    <label for="email">Email:</label>
                    <input type="email" name="email"  required id="" style="height: 40px; width: 90%;">
                </div>
                <div class="form-group">
                    <label for="password">Password:</label>
                    <input type="password"  name="password" required id="password" style="height: 40px; width: 90%;">
              
                </div>
                <div class="form-group">
                    <label for="email">Upload Picture:</label>
                    <input type="file" name="file" class="form-control"  id="" style="height: 40px; width: 90%; padding-top: 7px;">
                </div>
                <div class="form-group">
