describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("build/docs/examples/example-location-hashbang-mode/index-jquery.php");
  });
  
var addressBar = element(by.css("#addressBar")),
     url = 'http://www.example.com/base/index.php#!/path?a=b#h';
...
it("should change $location accordingly", function() {
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index.php#!/first?a=b");
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/index.php#!/sec/ond?flag#hash");
