...
<body>
    ...
    <i class="fa-solid fa-cart-shopping" id="dec"></i>
    <div id="cart-items1">
    <?php
          ...
          ?>
          <table id="tab" style="margin: auto;">
                <tr>
                    <th>
                    ...
                    <th> - $<?=$price?></th>
                    <th> <a href="../includes/cartdelete.php?cid=<?=$cid?>" class="btn btn-danger bg-gradient"><i class="fa-solid fa-xmark" style="font-size: 24px;"></i></a></th>
                </tr>
...
<div id="message-container" class="alert   alert-warning  alert-dismissible" style="width: fit-content; margin: auto; position: absolute; left: 600px; top: 150px;">
...
<?php } ?>
  ...
  <footer style="margin-bottom: 0px; margin-top: 50px;">
    <div id="holdfoot">
        <div id="info">
