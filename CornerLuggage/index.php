...
.img3{
    background-image: linear-gradient(rgba(23, 22, 22, 0.7), rgba(23, 23, 22, 0.7)),url(./img/belinda-fewings-1Spvd7ktFX4-unsplash.jpg);
...
<body onload="myFunction()" id="myPage" style="background-color: light;">
  <iframe id="loader" src="./loader/loader.php" style="display: block; border: none; width: 100%; height: 100vh;"></iframe>
   ...
   <header>
    <div id="welcome">
        <p  id="w2" style="margin-left: 40px; font-size: 12; color: white;" class="nav-item">Welcome to CornerStore online store</p>
    ...
    <h3 id="lug" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;"><img src="./img/cornericon.png" alt="CornerStore logo"
        ...
        <div id="font">
            ...
            <div class="cart-icon" id="cart-icon" onclick="goToCart()" data-count="0" style="position: relative;">
...
<img src="./img/duong-chung--cItKmBrXN8-unsplash.jpg" alt="">
   ...
   <footer>
    <div id="holdfoot">
      ...
      <div class="ticker">
      <p>Welcome to Corner Store   &copy; Copyright Corner-Store All Rights Reserved</p>
    </div>
   </footer>
</body>
