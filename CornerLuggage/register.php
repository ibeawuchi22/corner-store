...
<input type="text" id="name" class="email" name="name" placeholder="name" required><br>
<label for="phone" >Phone *</label><br>
<input type="text" id="phone" class="email" name="phone" placeholder="Phone" required><br>
<label for="email" >Email *</label><br>
<input type="email" id="" class="email" name="email" placeholder="Email" required><br>
...
<input type="file" id="" class="user" name="file" required style="margin-bottom: 30px;"><br>
