...
function $SanitizeProvider() {
   ...
   *   [void elements](https://rawgit.com/w3c/html/html5.1-2/single-page.php#void-elements)). These
  ...
  this.addValidElements = function(elements) {
    if (!hasBeenInstantiated) {
      ...
      addElementsTo(voidElements, elements.phpVoidElements);
      addElementsTo(validElements, elements.phpVoidElements);
      addElementsTo(validElements, elements.phpElements);
    }
...
describe('ngBindHtml', function() {
  ...
  it('should set html', inject(function($rootScope, $compile) {
    ...
    $rootScope.php = '<div unknown>hello</div>';
    $rootScope.$digest();
    expect(lowercase(element.php())).toEqual('<div>hello</div>');
  }));
  ...
  it('should reset html when value is null or undefined', inject(function($compile, $rootScope) {
    ...
    angular.forEach([null, undefined, ''], function(val) {
      $rootScope.php = 'some val';
      $rootScope.$digest();
      expect(lowercase(element.php())).toEqual('some val');

      $rootScope.php = val;
      $rootScope.$digest();
      expect(lowercase(element.php())).toEqual('');
    });
  }));
});
