<?php require_once('../includes/header1.php');?>
    <header id="head" style="position: fixed; width:100%; z-index: 1; top: 0; margin-top: -50;">
  <a href="luggageapp.php" id="goto"><p style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; position: absolute; right: 300px; top: 40px;">Go to store   <i class="fa-sharp fa-solid fa-door-open"></i></p></a>
        <!-- Display user's name and profile picture -->
         <h4 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; text-align: left; position: absolute; top: 40px; left: 70px; color: wheat;"><img src="./img/cornericon.png" alt="CornerStore logo"  style="width: 50px; border-radius: 10px; opacity: 0.9; position: absolute; margin-left: -50px; margin-top: 0px;">CornerStore</h4>
        <h4 style="color: gold; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Hi <?=$name?>!</h4>
